...
function getWordTranslation(options: RouteOptions, callback) {
...
function getConfig(options: RouteOptions, callback) {
    chrome.storage.sync.get('config', function (items) {
        callback(items)
    })
}

function setConfig(options: RouteOptions, callback) {
...
chrome.runtime.onMessage.addListener(function (message, sender, callback) {
    ...
    function route(action: string, func: Function) {
